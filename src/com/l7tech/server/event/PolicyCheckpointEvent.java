...
public class PolicyCheckpointEvent extends ApplicationEvent {
     ...
     * @param newEntity if true, this is a newly-created entity.  If false, an existing entity was just updated.
     */
    public PolicyCheckpointEvent(Object source, Policy policyBeingSaved, boolean activated, boolean newEntity) {
        super(source);
    ...
    /**
     * @return true if this is a new entity being created
     */
