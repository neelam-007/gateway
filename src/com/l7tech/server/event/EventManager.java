...
public class EventManager {
    ...
    public void removePromoter(EventPromoter promoter) {
        removeFromMapOfSets(promoter, promotersByEventClass);
    }

    public void fireInNewTransaction(Event event) {
        fire(event);
    }
    ...
    public void addPromoter(Class eventClass, EventPromoter promoter) {
    ...
    private void collectEventClassMap(Map map, Set listeners, Class eventClass) {
    ...
    private void addToMapOfSets(Class eventClass, Object thing, Map map) {
    ...
    private void removeFromMapOfSets(Object thing, Map map) {
        Sync read = lock.readLock();
        Sync write = lock.writeLock();
        try {
            read.acquire();
    ...
    private Map listenersByEventClass = new HashMap();
    private Map promotersByEventClass = new HashMap();
