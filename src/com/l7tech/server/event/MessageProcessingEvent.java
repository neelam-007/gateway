...
/**
 * Instances are created and fired by {@link MessageProcessor} and/or {@link ServerAssertion}s to
 * notify components of the status of message processing.
 * <p/>
 * In order to receive events, components must register as a Spring bean (e.g. in <code>webApplicationContext.xml</code>)
 * and implement {@link ApplicationListener}.
 */
