...
public class PerformanceMetricsAggregator implements TrafficMonitor {
    ...
    public String handlePerformanceWindowRequest(WSMFService.RequestContext context) {
        ...
        try {
            ...
            Element getel = XmlUtil.findFirstChildElementByName(body, "http://openview.hp.com/xmlns/mip/2005/03/Wsee", "Get");
            Element param0 = XmlUtil.findFirstChildElementByName(getel, "http://openview.hp.com/xmlns/mip/2005/03/Wsee", "param0");
            String param0Value = XmlUtil.getTextValue(param0);
