...
public class ServiceMetricsManager extends HibernateDaoSupport
    ...
    public void destroy() throws Exception {
        ...
        if (flusherThread != null) flusherThread.interrupt();
    }
        ...
        if (_enabled) {
            ...
            synchronized (_serviceMetricsMapLock) {
                ...
                if (serviceMetrics == null) {
                    serviceMetrics = new ServiceMetrics(serviceOid, clusterNodeId, fineBinInterval, queue);
    ...
    protected void initDao() throws Exception {
        ...
        flusherThread = new Thread(flusher, flusher.getClass().getName());
        flusherThread.start();
    }
                                ...
                                getHibernateTemplate().execute(new HibernateCallback(){
                                    public Object doInHibernate(Session session) throws HibernateException {
                                        ...
                                        if (existing == null) {
                                            ...
                                            logger.log(Level.WARNING, "Merging contents of duplicate MetricsBin [ClusterNodeId={0}; ServiceOid={1}; Resolution={2}; PeriodStart={3}]",
