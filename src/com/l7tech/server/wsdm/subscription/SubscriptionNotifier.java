...
import com.l7tech.common.message.HttpRequestKnobAdapter;
...
public class SubscriptionNotifier implements ServiceStateMonitor, ApplicationContextAware {
        ...
        try {
            ...
            if ( status == 200 ) {
                ...
                if ( logger.isLoggable(Level.FINE) )  {
                    ...
                    if ( in != null ) {
                        byte[] body = HexUtils.slurpStream(new ByteLimitInputStream(in, 16, 10*1024*1024));
    ...
    private String getResource(String resName, ServiceStatusNotificationContext ssnc) throws IOException {
        ...
        String output = new String(HexUtils.slurpStream(i));
