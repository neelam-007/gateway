 ...
 *  - actually fetching the user object over HTTP
 * <p/>
 * The services provided by the abstract class are restricted synchronization and WaitMode behavior.
 */
public abstract class AbstractHttpObjectCache<UT> implements UrlResolver<UT> {
    ...
    /**
     * Construct a new AbstractHttpObjectCache.
     *
     * @param maxCacheAge
     * @param defaultWaitMode
     */
    protected AbstractHttpObjectCache(long maxCacheAge, WaitMode defaultWaitMode) {
     ...
     *                              </ul>
     * @return a {@link com.l7tech.common.http.cache.AbstractHttpObjectCache.FetchResult}.  Never null.  It may contain the most recently cached user object (which
    ...
    protected static final class DatedUserObject<UT> {
         ...
         *                      back to {@link AbstractHttpObjectCache#doHttpGet} the next time it is called on this
         *                      URL.
         */
     ...
     */
    protected abstract DatedUserObject<UT> doHttpGet(String urlStr, String lastModifiedStr, long lastSuccessfulPollStarted) throws IOException;
     ...
     * Concrete classes can subclass this and override {@link AbstractHttpObjectCache#newCacheEntry}
    ...
    public static class FetchResult<UT> {
         ...
         *
         * @return one of
         *   {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_DOWNLOAD_FAILED},
         *   {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_DOWNLOADING_NOW},
         *   {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_DOWNLOAD_SUCCESS}, or
         *   {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_USED_CACHED}.
         */
         ...
         * <p/>
         * This may be absent if {@link #getResult} is anything other than {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_USED_CACHED}
         * or {@link com.l7tech.common.http.cache.HttpObjectCache#RESULT_DOWNLOAD_SUCCESS}, but may be present even if the current download
