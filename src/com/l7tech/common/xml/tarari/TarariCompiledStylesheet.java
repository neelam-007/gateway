...
public interface TarariCompiledStylesheet {
     ...
     * @param vars    a Map of variables to make available to the stylesheet.  May be null.
     ...
     */
    void transform(TarariMessageContext input, OutputStream output, Map vars) throws IOException, SAXException;
     ...
     * @throws IOException if there is a problem writing to output
     */
    void transform(InputStream input, OutputStream output, Map vars) throws SAXException, IOException;
}
