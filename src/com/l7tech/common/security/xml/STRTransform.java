...
public class STRTransform extends Transform {
    ...
    public void setParameter(Node node) {
        ...
        if (params == null) {
        ...
        else if (!XmlUtil.elementInNamespace(params, SoapUtil.SECURITY_URIS_ARRAY) &&
            ...
            try {
                Element canonMethodEle = XmlUtil.findOnlyOneChildElementByName(params, SoapUtil.DIGSIG_URI, "CanonicalizationMethod");
