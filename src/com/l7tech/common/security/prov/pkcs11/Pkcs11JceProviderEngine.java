package com.l7tech.common.security.prov.pkcs11;
 ...
 * property (defaults to "/ssg/etc/conf/partitions/default_/pkcs11.cfg").
 */
public class Pkcs11JceProviderEngine implements JceProviderEngine {
    ...
    private static final String DEFAULT_CONFIG_PATH = "/ssg/etc/conf/partitions/default_/pkcs11.cfg";
