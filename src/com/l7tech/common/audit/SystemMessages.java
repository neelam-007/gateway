...
public class SystemMessages extends Messages {
    ...
    public static final M CERTVAL_REV_URL_INVALID             = m(2043, Level.WARNING, "Invalid {0} URL: {0}");
    ...
    public static final M CERTVAL_REV_CRL_INVALID             = m(2052, Level.WARNING, "CRL at {0} is invalid: {1}");
