...
public class CommonMessages extends Messages {
    ...
    public static final M TEMPLATE_SUSPICIOUS_TOSTRING  = m(151, Level.WARNING, "Variable ''{0}'' is a {1}, which is not known to have a useful toString()");
    public static final M TEMPLATE_UNSUPPORTED_VARIABLE = m(152, Level.WARNING, "Unsupported variable: {0}");
}
