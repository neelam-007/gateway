...
public class AssertionMessages extends Messages {
    ...
    public static final M THROUGHPUT_QUOTA_EXCEEDED =    m(6900, Level.WARNING, "Quota exceeded on counter {0}. Assertion limit is {1} current counter value is {2}");
    public static final M THROUGHPUT_QUOTA_ALREADY_MET = m(6901, Level.WARNING, "Quota already exceeded on counter {0}.");
