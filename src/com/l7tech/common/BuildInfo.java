...
public class BuildInfo {
    ...
    private static final String BUILD_NUMBER = "3422";      // ie, 1014
    ...
    private static final String BUILD_DATE = "20070730";  // ie, 20030916
    private static final String BUILD_TIME = "102521";  // ie, 153238
