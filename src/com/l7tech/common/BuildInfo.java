...
public class BuildInfo {
    ...
    private static final String BUILD_NUMBER = "3525";      // ie, 1014
    private static final String PRODUCT_VERSION = "HEAD";   // ie, 3.4b (human readable)
    private static final String PRODUCT_VERSION_MAJOR = "5"; // ie, 3
    ...
    private static final String BUILD_DATE = "20080619";  // ie, 20030916
    private static final String BUILD_TIME = "112450";  // ie, 153238
    private static final String BUILD_USER = "megery";  // ie, alex
    private static final String BUILD_MACHINE = "armus.l7tech.com"; // ie, locutus.l7tech.com
