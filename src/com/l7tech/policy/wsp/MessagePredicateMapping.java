    ...
    public Element freeze(WspWriter wspWriter, TypedReference object, Element container) {
        ...
        if (xba instanceof SimpleXpathAssertion) {
            ...
            if (val != null && val.length() > 0) {
                String nsprefix = XmlUtil.findActivePrefixForNamespace(messagePredicate, WspConstants.L7_POLICY_NS);
                if (nsprefix == null) nsprefix = XmlUtil.findUnusedNamespacePrefix(messagePredicate, "l7p");
