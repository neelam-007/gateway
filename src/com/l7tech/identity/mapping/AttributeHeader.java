...
import static com.l7tech.identity.mapping.AttributeHeader.Builtin.CUSTOM;
import static com.l7tech.policy.variable.DataType.STRING;
import static com.l7tech.identity.mapping.UsersOrGroups.USERS;
import static com.l7tech.identity.mapping.UsersOrGroups.BOTH;
...
public class AttributeHeader extends NamedEntityImp implements Serializable {
    ...
    AttributeHeader(String variableName, String name, DataType type, UsersOrGroups uog, Builtin builtin) {
