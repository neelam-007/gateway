 ...
 * $Id$
 */
public class VirtualGroupPanel extends EntityEditorPanel {
    ...
    private final ActionListener closeDlgListener = new ActionListener() {
                                                      public void actionPerformed(ActionEvent e) {
                                                          SwingUtilities.windowForComponent(VirtualGroupPanel.this).dispose();
                                                      }
                                                    };
     ...
     * constructor
     */
    public VirtualGroupPanel(IdentityProviderConfig ipc) {
        this.ipc = ipc;
    }
    ...
    private JPanel getMembershipPanel() {
            ...
            if (config.isWritable()) {
                okButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        Window dlg = SwingUtilities.windowForComponent(VirtualGroupPanel.this);
          ...
          public void hierarchyChanged(HierarchyEvent e) {
              ...
              if (eID == HierarchyEvent.HIERARCHY_CHANGED &&
                ((flags & HierarchyEvent.DISPLAYABILITY_CHANGED) == HierarchyEvent.DISPLAYABILITY_CHANGED)) {
                  if (VirtualGroupPanel.this.isDisplayable()) {
                      JDialog d = (JDialog)SwingUtilities.windowForComponent(VirtualGroupPanel.this);
                      if (d != null) {
