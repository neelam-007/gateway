...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        _1 = new JPanel();
        mainPanel = _1;
        _1.setLayout(new GridLayoutManager(5, 3, new Insets(0, 0, 0, 0), -1, -1));
        final JPanel _2;
        _2 = new JPanel();
        _2.setLayout(new GridLayoutManager(3, 1, new Insets(0, 0, 0, 0), -1, -1));
        _1.add(_2, new GridConstraints(2, 1, 1, 2, 0, 3, 3, 3, null, null, null));
        final JLabel _3;
        _3 = new JLabel();
        _3.setText("Details:");
        ...
        final Spacer _5;
        _5 = new Spacer();
        _2.add(_5, new GridConstraints(2, 0, 1, 1, 0, 2, 1, 6, new Dimension(-1, 8), new Dimension(-1, 8), null));
        final JScrollPane _6;
        _6 = new JScrollPane();
        certScrollPane = _6;
        _1.add(_6, new GridConstraints(3, 1, 1, 1, 0, 3, 7, 7, null, null, null));
        final Spacer _7;
        _7 = new Spacer();
        _1.add(_7, new GridConstraints(4, 1, 1, 2, 0, 2, 1, 6, new Dimension(-1, 10), new Dimension(-1, 10), null));
        final JPanel _8;
        _8 = new JPanel();
        _8.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1));
        _1.add(_8, new GridConstraints(1, 1, 1, 1, 0, 3, 3, 3, null, null, null));
        final JLabel _9;
        _9 = new JLabel();
        _9.setText("Certificate Name");
        _8.add(_9, new GridConstraints(0, 0, 1, 1, 8, 0, 0, 0, null, null, null));
        final JTextField _10;
        _10 = new JTextField();
        certNameTextField = _10;
        _8.add(_10, new GridConstraints(0, 1, 1, 1, 8, 1, 6, 0, null, new Dimension(150, -1), null));
        final Spacer _11;
        _11 = new Spacer();
        _1.add(_11, new GridConstraints(0, 1, 1, 1, 0, 2, 1, 6, new Dimension(-1, 10), new Dimension(-1, 10), null));
    }
