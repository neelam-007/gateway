...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        _1 = new JPanel();
        mainPanel = _1;
        _1.setLayout(new GridLayoutManager(3, 3, new Insets(0, 0, 0, 0), -1, -1));
        final JPanel _2;
        _2 = new JPanel();
        _2.setLayout(new GridLayoutManager(3, 1, new Insets(0, 0, 0, 0), -1, -1));
        _1.add(_2, new GridConstraints(0, 1, 1, 2, 0, 3, 3, 3, null, null, null));
        final JLabel _3;
        _3 = new JLabel();
        _3.setText("Certificate Details");
        _2.add(_3, new GridConstraints(1, 0, 1, 1, 8, 0, 0, 0, null, null, null));
        final Spacer _4;
        _4 = new Spacer();
        _2.add(_4, new GridConstraints(0, 0, 1, 1, 0, 2, 1, 6, new Dimension(-1, 10), new Dimension(-1, 10), null));
        final Spacer _5;
        _5 = new Spacer();
        _2.add(_5, new GridConstraints(2, 0, 1, 1, 0, 2, 1, 6, new Dimension(-1, 10), new Dimension(-1, 10), null));
        final JScrollPane _6;
        _6 = new JScrollPane();
        certScrollPane = _6;
        _1.add(_6, new GridConstraints(1, 1, 1, 1, 0, 3, 7, 7, null, null, null));
        final Spacer _7;
        _7 = new Spacer();
        _1.add(_7, new GridConstraints(2, 1, 1, 2, 0, 2, 1, 6, new Dimension(-1, 10), new Dimension(-1, 10), null));
    }
