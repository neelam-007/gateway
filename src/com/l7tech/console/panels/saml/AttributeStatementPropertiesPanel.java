...
/**
 * The <code>AttributeStatementPropertiesPanel</code> edits the
 * configuration of the SAML attribute statement constraints.
 *
 * @author emil
 * @version Jan 18, 2005
 */
public class AttributeStatementPropertiesPanel extends JDialog {
     ...
     * Creates new wizard
     */
    public AttributeStatementPropertiesPanel(SamlAttributeStatement assertion, Frame parent, boolean modal) {
        super(parent);
        if (assertion == null) {
            throw new IllegalArgumentException();
        }
        this.assertion = assertion;
        setTitle("SAML Attribute Statement Constraints");
        setModal(modal);
