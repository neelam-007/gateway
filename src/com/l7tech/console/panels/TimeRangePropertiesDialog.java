...
public class TimeRangePropertiesDialog extends JDialog {
    ...
    private JComponent makeDayOfWeekPanel() {
        ...
        dayOfWeekPanel.setLayout(new BoxLayout(dayOfWeekPanel, BoxLayout.Y_AXIS));
        enableDayOfWeek = new JCheckBox("Restrict day of week");
        dayOfWeekPanel.add(enableDayOfWeek);
        // todo
        return wrapAroundBorders(dayOfWeekPanel, CONTROL_SPACING, CONTROL_SPACING, CONTROL_SPACING, CONTROL_SPACING);
    }
