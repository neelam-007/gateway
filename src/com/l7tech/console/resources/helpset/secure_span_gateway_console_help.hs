...
<helpset version="1.0">
  <title>Secure Span Gateway Console Help</title>
   <maps>
    ...
    <mapref location="secure_span_gateway_console_help_map.xml" />
  </maps>
  ...
  <view>
    ...
    <data engine="com.sun.java.help.search.DefaultSearchEngine">secure_span_gateway_console_help_JavaHelpSearch</data>
  </view>
