 ...
 * It represents the XML digital signature of the soap request.
 *
 * @author flascell
 * @version 1.0
 */
public class XmlSignatureReqNode extends AbstractTreeNode {
    /**
     * construct the <CODE>SslTransportNode</CODE> instance.
     */
    public XmlSignatureReqNode(){
        super(null);
    }
    ...
    public String getName() {
        return "XML signature on request";
