 ...
 * @version 1.0
 */
public class ResponseWssConfidentialityNode extends AbstractLeafPaletteNode {
    public ResponseWssConfidentialityNode() {
        super("Encrypt Response Element", "com/l7tech/console/resources/xmlencryption.gif");
    }
