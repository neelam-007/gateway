 ...
 * It represents the XML encryption of the response node.
 *
 * @author flascell
 * @version 1.0
 */
public class XmlEncryptionResNode extends AbstractTreeNode {
    /**
     * construct the <CODE>SslTransportNode</CODE> instance.
     */
    public XmlEncryptionResNode(){
        super(null);
    }
