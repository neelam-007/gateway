...
ANT_JARS="$SRC_ROOT/lib/ant.jar:$SRC_ROOT/lib/ant-launcher.jar:$SRC_ROOT/lib/ant-nodeps.jar:$SRC_ROOT/lib/xercesImpl.jar:$SRC_ROOT/lib/xml-apis.jar:$SRC_ROOT/lib/tools/junit-4.4.jar:$SRC_ROOT/lib/ant-junit.jar:$SRC_ROOT/lib/ant-contrib-1.0b3.jar:$SRC_ROOT/lib/xalan-2.5.2.jar:$SRC_ROOT/lib/ant-apache-bcel.jar:$SRC_ROOT/lib/tools/ant-trax.jar:$SRC_ROOT/lib/tools/bcel-5.2.jar:$SRC_ROOT/lib/tools/ivy-2.0.0-rc1.jar:$SRC_ROOT/lib/tools/oro-2.0.8.jar"
