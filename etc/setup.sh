...
do
    clear
    echo "CA API Gateway Software configuration menu."
    echo ""
    echo "What would you like to do?"
    echo ""
    echo " 1) Upgrade the CA API Gateway database"
    echo " 2) Configure the CA API Gateway"
    echo " 3) Display the current CA API Gateway configuration"
    echo " 4) Change the CA API Gateway Cluster Passphrase"
