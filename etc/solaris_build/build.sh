...
du -a ./opt/SecureSpan/Controller | grep -v "etc" | grep -v "var/logs" | grep -v "var/patches" | grep -v "var/run" | awk '{print $2}' | pkgproto | sed -e "s/$CURRENT_OWNER/layer7 layer7/"   >> ../pkgbuild/Prototype
