...
sub fix_keystore($$) {
	...
	`JAVA_HOME=/ssg/j2sdk1.4.2_05 \$JAVA_HOME/bin/java -classpath /ssg/tomcat/common/classpath/bcprov-jdk14-135.jar:/ssg/tomcat/webapps/ROOT/WEB-INF/classes com.l7tech.common.security.CopyKeystore /tmp/working.ks JKS /tmp/working.p12 BCPKCS12 $keypass`;
