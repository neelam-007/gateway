...
default_java_opts="-Dfile.encoding=UTF-8 -Dnetworkaddress.cache.ttl=30 -Xms${java_ram}k -Xmx${java_ram}k -Xss256k -server -Djava.awt.headless=true -XX:CompileThreshold=1500 "
