 ...
 * $Id$
 */
public class ClientRequestWssIntegrity extends ClientDomXpathBasedAssertion<RequireWssSignedElement> {
    private static final Logger log = Logger.getLogger(ClientRequestWssIntegrity.class.getName());

    public ClientRequestWssIntegrity(RequireWssSignedElement data) {
        super(data);
    }
