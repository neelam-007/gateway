...
public class ServerStripPartsAssertionTest extends TestCase {
    ...
    public void testStripRequest() throws Exception {
        ...
        log.info("Stripped message: " + new String(HexUtils.slurpStream(mess.getMimeKnob().getEntireMessageBodyAsInputStream())));
    }
    ...
    public void testStripResponse() throws Exception {
        ...
        log.info("Stripped message: " + new String(HexUtils.slurpStream(context.getResponse().getMimeKnob().getEntireMessageBodyAsInputStream())));
    }
