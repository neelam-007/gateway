...
public class BusinessServicePublisherTest {
    ...
    public void testFirstPublishOfGifEndPoint() throws Exception {
        ...
        validateProxyGifReferences(endpointPair, proxyReferences);
...
//        }
    ...
    private void validateProxyGifReferences(EndpointPair endpointPair, List<KeyedReference> proxyReferences) {
        Assert.assertEquals("Incorrect number of keyedReferences found", 4, proxyReferences.size());
    ...
    public void testUpdatePublishOfGifEndPoint() throws Exception {
        ...
        final List<KeyedReference> proxyReferences = proxyTemplate.getCategoryBag().getKeyedReference();
        Assert.assertEquals("Incorrect number of proxy references found", 4, proxyReferences.size());
