...
/**
 * Functions for diff to computes the difference between two texts with a behaviour setting.
 * Download site: http://code.google.com/p/google-diff-match-patch/
 * File name: diff_match_patch_20121119.zip
 *
 * @author fraser@google.com (Neil Fraser)
 *
 * Modified by CA Layer 7 Technologies to support Policy Diff Feature (FR-94: https://jira.l7tech.com:8443/browse/FR-94)
 */
public class GoogleDiffUtils {

    /**
     * Default.
     * Set it on your diff instance to override the default.
     *
