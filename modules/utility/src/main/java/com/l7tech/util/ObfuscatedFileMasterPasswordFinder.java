 ...
 */
public class ObfuscatedFileMasterPasswordFinder implements MasterPasswordManager.MasterPasswordFinder {
     ...
     */
    public ObfuscatedFileMasterPasswordFinder() {
     ...
     */
    public ObfuscatedFileMasterPasswordFinder(File masterPasswordFile) {
