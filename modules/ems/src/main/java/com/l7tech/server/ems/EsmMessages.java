...
public class EsmMessages extends Messages {
    ...
    public static final M CHANGE_NOTIFICATION_SETUP_MESSAGE      = m(100005, Level.INFO, "Change notification setup: {0} is {1}");
    ...
    public static final M AUDIT_ALERT_TRIGGERED_MESSAGE   = m(100007, Level.WARNING, "Status from normal to alert message: {0} entered trigger condition.");
    public static final M AUDIT_ALERT_NOT_APPLIED_MESSAGE = m(100008, Level.INFO, "Status from alert to normal message: {0} cleared trigger condition.");
