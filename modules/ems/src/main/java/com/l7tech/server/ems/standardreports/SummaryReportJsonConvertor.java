...
public class SummaryReportJsonConvertor implements JsonReportParameterConvertor {
    ...
    protected Map<String, Map<String, ReportApi.ReportSubmission.ReportParam>> getReportParams(Map params, String reportRanBy) throws ReportException {
        ...
        //Use page breaks
        ReportApi.ReportSubmission.ReportParam isIgnorePagniation = new ReportApi.ReportSubmission.ReportParam();
        isIgnorePagniation.setName(ReportApi.ReportParameters.IS_IGNORE_PAGINATION);
        Boolean noPageBreaks = (Boolean) params.get(JSONConstants.IS_IGNORING_PAGINATION);
        isIgnorePagniation.setValue(Boolean.valueOf(noPageBreaks));
        addParamToAllClusters(clusterToReportParams, ReportApi.ReportParameters.IS_IGNORE_PAGINATION, isIgnorePagniation);
    ...
    private void validateParams(Map params) {
        String[] requiredParams = new String[]{JSONConstants.REPORT_TYPE, JSONConstants.ENTITY_TYPE, JSONConstants.REPORT_ENTITIES,
                ...
                JSONConstants.SUMMARY_REPORT, JSONConstants.REPORT_NAME, JSONConstants.IS_IGNORING_PAGINATION};
