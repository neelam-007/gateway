...
public class YuiCommon {
    ...
    static final ResourceReference RES_JS_DATASOURCE = new CompressedResourceReference(YuiCommon.class, "../resources/yui/datasource/datasource-beta-min.js" );
    ...
    static final ResourceReference RES_JS_DATATABLE = new CompressedResourceReference(YuiCommon.class, "../resources/yui/datatable/datatable-beta-min.js" );
