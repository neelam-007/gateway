...
class YuiCommon {
    ...
    static final ResourceReference RES_JS_DATASOURCE = new CompressedResourceReference(YuiCommon.class, "../resources/yui/datasource/datasource-min.js" );
    static final ResourceReference RES_JS_DRAGDROP = new CompressedResourceReference(YuiCommon.class, "../resources/yui/dragdrop/dragdrop-min.js" );
    static final ResourceReference RES_JS_DATATABLE = new CompressedResourceReference(YuiCommon.class, "../resources/yui/datatable/datatable-min.js" );
    static final ResourceReference RES_JS_PAGINATOR = new CompressedResourceReference(YuiCommon.class, "../resources/yui/paginator/paginator-min.js" );
    static final ResourceReference RES_JS_EVENT = new CompressedResourceReference(YuiCommon.class, "../resources/yui/event/event-min.js" );
