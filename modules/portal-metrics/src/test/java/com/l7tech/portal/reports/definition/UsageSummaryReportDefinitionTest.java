...
public class UsageSummaryReportDefinitionTest {
    public static final long START = 1;
    public static final long END = 2;
    public static final int RESOLUTION = 3;
    private UsageSummaryReportDefinition definition;
    private UsageSummaryReportParameters parameters;
    ...
    public void setup() {
        ...
        parameters = new UsageSummaryReportParameters(START, END, RESOLUTION, Format.XML, applicationKeys);
        definition = new UsageSummaryReportDefinition(parameters);
    }
    ...
    public void setParametersSingleApi() throws Exception {
        ...
        verify(statement).setString(3, "key1");
    }
    ...
    public void setParametersMultipleApis() throws Exception {
        ...
        verify(statement).setLong(2, END);
        verify(statement).setString(3, "key1");
        verify(statement).setString(4, "key2");
        verify(statement).setString(5, "key3");
    }
