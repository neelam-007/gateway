...
import static com.l7tech.portal.reports.definition.LatencyRankingReportDefinition.LIMIT;
import static com.l7tech.portal.reports.definition.LatencyRankingReportDefinition.QUERY;
...
public class LatencyRankingReportDefinitionTest {
    private LatencyRankingReportDefinition definition;
    ...
    public void setup() {
        ...
        definition = new LatencyRankingReportDefinition(params);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructorNull() {
        definition = new LatencyRankingReportDefinition(null);
    }
