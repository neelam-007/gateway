...
import static com.l7tech.portal.reports.definition.ApplicationRankingReportDefinition.LIMIT;
import static com.l7tech.portal.reports.definition.ApplicationRankingReportDefinition.QUERY;
...
public class ApplicationRankingReportDefinitionTest {
    private ApplicationRankingReportDefinition definition;
    ...
    public void setup() {
        ...
        definition = new ApplicationRankingReportDefinition(params);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructorNull() {
        definition = new ApplicationRankingReportDefinition(null);
    }
