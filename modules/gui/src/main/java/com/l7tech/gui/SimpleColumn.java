...
public class SimpleColumn<RT> {
     ...
     * @see com.l7tech.util.Functions#propertyTransform(Class, String) for an easy way to generate a valueGetter for any bean property of RT
     * @see com.l7tech.util.Functions#getterTransform(java.lang.reflect.Method) for an easy way to generate a valueGetter for any nullary method of RT
     */
