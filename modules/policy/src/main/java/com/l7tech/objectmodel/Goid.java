...
public final class Goid implements Comparable<Goid>, Serializable {
    /**
     * Goid's are serialized and deserialized in many places. This serialVersionUID is the same as the autogenerated one
     * from the 8.0 (Halibut) release. See SSG-8427
     */
    private static final long serialVersionUID = 944098623320485131L;
