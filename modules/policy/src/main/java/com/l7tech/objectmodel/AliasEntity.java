 ...
 * HT represents the concrete subclass. This is a bit strange however it allows for classes which want to
 ...
 */
public abstract class AliasEntity <HT extends NamedEntityImp> extends NamedEntityImp implements EntityAlias {
    ...
    public AliasEntity(HT entity, long folderOid) {
        super(entity);
     ...
     */
    public AliasEntity(final HT entity) {
        super(entity);
    }
