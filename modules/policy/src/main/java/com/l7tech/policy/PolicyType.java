...
public enum PolicyType {
     ...
     */
    INTERNAL(FRAGMENT, "Internal Use Policy", true, getAuditMessageFilterTags(), false, true),
    ...
    /**
     * A policy that is invoked by method calls on a proxy generated by the PolicyBackedServiceRegistry.
     */
    POLICY_BACKED_OPERATION(FRAGMENT, "Policy-Backed Service Operation Policy Fragment", true, null, false, true),
    ...
    private PolicyType(Supertype supertype, String name, boolean includeInGui, Collection<String> guiTags, boolean securityZoneable) {
        this(supertype, name, includeInGui, guiTags, securityZoneable, false);
    }

    private PolicyType(Supertype supertype, String name, boolean includeInGui, Collection<String> guiTags, boolean securityZoneable, boolean dynamicTags ) {
    ...
    /**
     * @return true if policies of this type have valid sets of tags and subtags that are generated dynamically.
     *         for such policy types, the server must be queried for the set of tags (and, for each tag, subtags)
