...
public class GoidTest {
    ...
    @Test( expected = IllegalArgumentException.class )
    @BugId( "SSG-13849" )
    public void testDecompressLongString() throws Exception {
        new Goid("");
    }

    @Test( expected = IllegalArgumentException.class )
    @BugId( "SSG-13849" )
    public void testDecompressTooManyNs() throws Exception {
        new Goid("nnn");
    }

    @Test( expected = IllegalArgumentException.class )
    @BugId( "SSG-13849" )
    public void testDecompressTooManyZs() throws Exception {
        new Goid("zzz");
    }
}
