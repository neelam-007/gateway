...
public class FimWorkshopTest extends TestCase {
    ...
    public void testReproClientRst() throws Exception {
        ...
        Document clientRst = null;//TestDocuments.getTestDocument(TestDocuments.FIM2005APR_CLIENT_RST);
    ...
    public void testParseClientRstr() throws Exception {
        ...
        Document clientRstr = null;//TestDocuments.getTestDocument(TestDocuments.FIM2005APR_CLIENT_RSTR);
    ...
    public void testReproServerRst() throws Exception {
        ...
        Document serverRst = null;//TestDocuments.getTestDocument(TestDocuments.FIM2005APR_SERVER_RST);
    ...
    public void testParseServerRstr() throws Exception {
        ...
        Document serverRstr = null;//TestDocuments.getTestDocument(TestDocuments.FIM2005APR_SERVER_RSTR);
