...
public class AssertionAccessMigration extends com.l7tech.skunkworks.rest.tools.MigrationTestBase {
    private static final Logger logger = Logger.getLogger(AssertionAccessMigration.class.getName());
