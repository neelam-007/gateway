...
public class PolicyVersionRestEntityResourceTest extends RestEntityTestBase {
    private static final Logger logger = Logger.getLogger(PolicyVersionRestEntityResourceTest.class.getName());
    ...
    public void getNonExistingPolicyVersionBadPolicy() throws Exception {
        RestResponse response = getDatabaseBasedRestManagementEnvironment().processRequest("policies/" + new Goid(0, 123) + "/versions/0", HttpMethod.GET, null, "");
        logger.log(Level.INFO, response.toString());
    ...
    public void  updateVersionCommentBadPolicy() throws Exception {
        RestResponse response = getDatabaseBasedRestManagementEnvironment().processRequest("policies/" + new Goid(0, 123) + "/versions/0/comment", HttpMethod.PUT, "text/plain", "My Comment");
        logger.log(Level.INFO, response.toString());
    ...
    @BugId("SSG-8283")
    @Test
    public void getDifferentPolicyType() throws Exception {
        //Create Policy
        ...
        RestResponse response = getDatabaseBasedRestManagementEnvironment().processRequest("policies/" + servicePolicy.getId() + "/versions/" + servicePolicyVersion.getOrdinal(), HttpMethod.GET, null, "");
        logger.log(Level.INFO, response.toString());
    ...
    public void activatePolicyVersion() throws Exception {
        ...
        List<PolicyVersion> versions = policyVersionManager.findAllForPolicy(policy.getGoid());
    ...
    public String getResourceUri() {
        return "policies/" + policy.getId() + "/versions";
    }
