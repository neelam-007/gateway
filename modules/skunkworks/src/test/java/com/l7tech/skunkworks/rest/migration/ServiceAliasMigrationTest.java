...
public class ServiceAliasMigrationTest extends MigrationTestBase {
    private static final Logger logger = Logger.getLogger(ServiceAliasMigrationTest.class.getName());
