...
public class Component {
    ...
    public static final Component GW_AUDIT_PROPERTIES_CONFIG = new Component(  40010, "Audit Properties Configuration", GW_AUDIT_SYSTEM);
    ...
    public static final Component     GW_ACCOUNT_MANAGER  = new Component(  90060, "Administrator account maintenace", GW_SERVER);
