...
public interface AuditAdmin extends GenericLogAdmin {
     ...
     * @return String output from the AV policy or any error messages generated by attempting to process the policy.
    ...
    String invokeAuditViewerPolicyForMessage(long auditRecordId, boolean isRequest) throws FindException;
     ...
     * @return String output of the audit policy. Null if any problem processing the policy.
     * @throws FindException if AV policy cannot be accessed.
     */
    @Secured(stereotype = ENTITY_OPERATION, otherOperation = "audit-viewer policy", relevantArg = 0)
    String invokeAuditViewerPolicyForDetail(long auditRecordId, long ordinal) throws FindException;
