...
public class AssertionMessages extends Messages {
    ...
    public static final M ICAP_RESPONSE_FINEST = m(4890, Level.FINEST, "The ( {0} ) detected the ( {1} ) virus with an ID of ( {2} ) this message {3}.");
    public static final M ICAP_RESPONSE_FINER = m(4891, Level.FINER, "The ( {0} ) detected the ( {1} ) virus with an ID of ( {2} ) this message {3}.");
    public static final M ICAP_RESPONSE_FINE = m(4892, Level.FINE, "The ( {0} ) detected the ( {1} ) virus with an ID of ( {2} ) this message {3}.");
    public static final M ICAP_RESPONSE_INFO = m(4893, Level.INFO, "The ( {0} ) detected the ( {1} ) virus with an ID of ( {2} ) this message {3}.");
    public static final M ICAP_RESPONSE_WARNING = m(4894, Level.WARNING, "The ( {0} ) detected the ( {1} ) virus with an ID of ( {2} ) this message {3}.");
