...
public class ServiceMessages extends Messages {
    ...
    public static final M ESM_SUBSCRIPTION_SERVICE_GONE = m(3657, Level.WARNING, "ESM Subscription service (oid=''{0}'') not found, using last known routing URI for its notifications: ''{1}''");
