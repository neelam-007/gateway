...
/**
 * Test JSONDataToCustomJASONData.
 *
 * @author tveninov
 */
public class CustomToJsonDataTest {
    ...
    public void testNullSupport() {
        ...
        new CustomToJsonData(null);
        fail("This message should not have been displayed");
    }

    @Test
    public void test() throws Exception {
        final CustomJsonData jsonData = new CustomToJsonData(JSONFactory.getInstance().newJsonData(JSON_SOURCE));
