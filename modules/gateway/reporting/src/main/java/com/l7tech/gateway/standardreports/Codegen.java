...
public class Codegen {
     ...
     */
    public byte[] compile() throws CompileException, ClassNotFoundException, IllegalStateException, UnsupportedOperationException {
        if (diagnostics != null)
        ...
        return bytecodes.values().iterator().next().getBytes();
    }
