...
public class MqNativeRoutingAssertion extends RoutingAssertion implements UsesVariables, SetsVariables {
    protected static final Logger logger = Logger.getLogger(MqNativeRoutingAssertion.class.getName());
   ...
   public boolean needsInitializedResponse() {
    ...
    private final static String baseName = "Route via MQ";
   ...
   public AssertionMetadata meta() {
       ...
       meta.put(AssertionMetadata.PROPERTIES_ACTION_NAME, "MQ Routing Properties");
