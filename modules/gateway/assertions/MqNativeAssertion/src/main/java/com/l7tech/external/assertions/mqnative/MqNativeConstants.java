...
public interface MqNativeConstants {
    ...
    String MQ_CONNECTION_POOL_MAX_ACTIVE_DESC = "Maximum number of active connections per MQ Native connection pool. Zero indicates no active connections. A negative value indicates unlimited active connections (Integer)";
    ...
    String MQ_CONNECTION_POOL_MAX_IDLE_DESC = "Maximum number of idle connections allowed in a MQ Native connection pool. A negative value indicates unlimited idle connections (Integer)";
    ...
    String MQ_CONNECTION_POOL_MAX_WAIT_DESC = "Maximum amount of time to wait for a MQ Native connection to become available. Value is in milliseconds. Zero or a negative value indicates wait indefinitely.";
