...
public class MqNativeModuleLoadListener {
    ...
    private static final List<PropertyRegistrationInfo> MODULE_CLUSTER_PROPERTIES = list(
            ...
            prInfo(MQ_CONNECTION_POOL_MAX_ACTIVE_PROPERTY, MQ_CONNECTION_POOL_MAX_ACTIVE_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_ACTIVE_DESC, "20", "integer" ),
            prInfo(MQ_CONNECTION_POOL_MAX_IDLE_PROPERTY, MQ_CONNECTION_POOL_MAX_IDLE_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_IDLE_DESC, "20", "integer" ),
            prInfo(MQ_CONNECTION_POOL_MAX_WAIT_PROPERTY, MQ_CONNECTION_POOL_MAX_WAIT_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_WAIT_DESC, "-1", "long" ) ,
            // message open, get, and put options properties
            prInfo(MQ_LISTENER_INBOUND_OPEN_OPTIONS_PROPERTY, MQ_LISTENER_INBOUND_OPEN_OPTIONS_UI_PROPERTY, MQ_LISTENER_INBOUND_OPEN_OPTIONS_DESC, null),
            prInfo(MQ_LISTENER_INBOUND_GET_MESSAGE_OPTIONS_PROPERTY, MQ_LISTENER_INBOUND_GET_MESSAGE_OPTIONS_UI_PROPERTY, MQ_LISTENER_INBOUND_GET_MESSAGE_OPTIONS_DESC, null),
            prInfo(MQ_LISTENER_INBOUND_REPLY_QUEUE_PUT_MESSAGE_OPTIONS_PROPERTY, MQ_LISTENER_INBOUND_REPLY_QUEUE_PUT_MESSAGE_OPTIONS_UI_PROPERTY, MQ_LISTENER_INBOUND_REPLY_QUEUE_PUT_MESSAGE_OPTIONS_DESC, null),
            prInfo(MQ_LISTENER_INBOUND_FAILED_QUEUE_PUT_MESSAGE_OPTIONS_PROPERTY, MQ_LISTENER_INBOUND_FAILED_QUEUE_PUT_MESSAGE_OPTIONS_UI_PROPERTY, MQ_LISTENER_INBOUND_FAILED_QUEUE_PUT_MESSAGE_OPTIONS_DESC, null),
            prInfo(MQ_LISTENER_OUTBOUND_REPLY_QUEUE_GET_MESSAGE_OPTIONS_PROPERTY, MQ_LISTENER_OUTBOUND_REPLY_QUEUE_GET_MESSAGE_OPTIONS_UI_PROPERTY, MQ_LISTENER_OUTBOUND_REPLY_QUEUE_GET_MESSAGE_OPTIONS_DESC, null),
            prInfo(MQ_ROUTING_PUT_OPEN_OPTIONS_PROPERTY, MQ_ROUTING_PUT_OPEN_OPTIONS_UI_PROPERTY, MQ_ROUTING_PUT_OPEN_OPTIONS_DESC, null),
            prInfo(MQ_ROUTING_PUT_MESSAGE_OPTIONS_PROPERTY, MQ_ROUTING_PUT_MESSAGE_OPTIONS_UI_PROPERTY, MQ_ROUTING_PUT_MESSAGE_OPTIONS_DESC, null),
            prInfo(MQ_ROUTING_GET_OPEN_OPTIONS_PROPERTY, MQ_ROUTING_GET_OPEN_OPTIONS_UI_PROPERTY, MQ_ROUTING_GET_OPEN_OPTIONS_DESC, null),
            prInfo(MQ_ROUTING_GET_MESSAGE_OPTIONS_PROPERTY, MQ_ROUTING_GET_MESSAGE_OPTIONS_UI_PROPERTY, MQ_ROUTING_GET_MESSAGE_OPTIONS_DESC, null)
    );
