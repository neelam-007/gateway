...
public class MqNativeModuleLoadListener {
    ...
    private static final List<PropertyRegistrationInfo> MODULE_CLUSTER_PROPERTIES = list(
            ...
            prInfo(MQ_CONNECTION_POOL_MAX_ACTIVE_PROPERTY, MQ_CONNECTION_POOL_MAX_ACTIVE_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_ACTIVE_DESC, "20" ),
            prInfo(MQ_CONNECTION_POOL_MAX_IDLE_PROPERTY, MQ_CONNECTION_POOL_MAX_IDLE_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_IDLE_DESC, "20" ),
            prInfo(MQ_CONNECTION_POOL_MAX_WAIT_PROPERTY, MQ_CONNECTION_POOL_MAX_WAIT_UI_PROPERTY, MQ_CONNECTION_POOL_MAX_WAIT_DESC, "-1" ) ,
