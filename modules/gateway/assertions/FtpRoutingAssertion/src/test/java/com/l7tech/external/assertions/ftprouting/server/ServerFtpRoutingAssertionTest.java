...
public class ServerFtpRoutingAssertionTest {
    ...
    @Test
    public void testAcct() throws IOException, PolicyAssertionException, SAXException, TooManyChildElementsException, MissingRequiredElementException, InvalidXpathException {
    ...
    @Test
    public void testList() throws IOException, PolicyAssertionException, SAXException, TooManyChildElementsException, MissingRequiredElementException, InvalidXpathException {
        FtpFileDetails testFile = LOG_FILE_DETAILS;
        ...
        try {
            responseContent = new String(IOUtils.slurpStream(context.getResponse().getMimeKnob().getEntireMessageBodyAsInputStream()));
        } catch (NoSuchPartException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void testGetLogFile() throws IOException, PolicyAssertionException {
        FtpFileDetails testFile = LOG_FILE_DETAILS;
    ...
    @Test
    public void testGetXmlFile() throws IOException, PolicyAssertionException {
    ...
    @Test
    public void testPutLogFile() throws IOException, PolicyAssertionException {
        FtpFileDetails testFile = LOG_FILE_DETAILS;
    ...
    @Test
    public void testPutXmlFile() throws IOException, PolicyAssertionException {
        FtpFileDetails testFile = XML_FILE_DETAILS;
        FtpMethod testMethod = FtpMethod.FTP_PUT;
