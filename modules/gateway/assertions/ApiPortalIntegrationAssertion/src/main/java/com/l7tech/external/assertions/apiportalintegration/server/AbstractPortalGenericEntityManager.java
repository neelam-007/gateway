...
public abstract class AbstractPortalGenericEntityManager<T extends AbstractPortalGenericEntity> implements PortalGenericEntityManager<T>, ApplicationListener {
  ...
  /**
   * Whitelist used by portal gem for xml decoding.
   */
  protected static final GenericEntityMetadata PORTAL_GENERIC_ENTITY_METADATA = new GenericEntityMetadata().
          addSafeXmlClasses("java.util.Date").
          addSafeXmlConstructors("java.util.Date(long)").
          addSafeXmlMethods("");
}
