...
public class ServerIncrementalSyncCommon {
    ...
    final static String SELECT_ENTITIES_SQL="SELECT %s , r.LATEST_REQ FROM APPLICATION a " +
            ...
            "GROUP BY a.UUID, a.NAME, o.NAME, a.API_KEY, a.KEY_SECRET, r.PREVIOUS_STATE, a.STATUS, a.ORGANIZATION_UUID, o.NAME, a.OAUTH_CALLBACK_URL, a.OAUTH_SCOPE, a.OAUTH_TYPE, a.MAG_SCOPE, a.MAG_MASTER_KEY, ax.API_UUID, a.CREATED_BY, a.MODIFIED_BY, r.LATEST_REQ, ax.API_UUID";
