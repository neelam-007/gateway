 ...
 */
@Secured
public interface ExtensibleSocketConnectorEntityAdmin {
    /**
     * Find all ExtensibleSocketConnectorEntity instances.
     *
    ...
    Collection<ExtensibleSocketConnectorEntity> findAll() throws FindException;

    /**
     * Save a new or changed ExtensibleSocketConnectorEntity.
     *
     * @param entity the entity to save.  Required.
     * @return the goid assigned to the entity (useful when saving a new one)
    ...
    Goid save(ExtensibleSocketConnectorEntity entity) throws SaveException, UpdateException;

    /**
     * Delete a ExtensibleSocketConnectorEntity.
     *
    ...
    void delete(ExtensibleSocketConnectorEntity entity) throws DeleteException, FindException;

    @Secured(stereotype = FIND_ENTITY)
    ExtensibleSocketConnectorEntity findByUniqueName(String name) throws FindException;
