...
public class CircuitBreakerAssertion extends Assertion implements UsesVariables {
    protected static final Logger logger = Logger.getLogger(CircuitBreakerAssertion.class.getName());
    ...
    public AssertionMetadata meta() {
        ...
        // that is, we want our required feature set to be "assertion:CircuitBreaker" rather than "set:modularAssertions"
