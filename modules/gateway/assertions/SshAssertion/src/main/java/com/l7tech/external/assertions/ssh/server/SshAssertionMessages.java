...
public class SshAssertionMessages extends Messages{
    ...
    /* Warning messages */
    public static final String SSH_NO_SUCH_PART_ERROR = "Connection established but Failed to SCP/SFTP to server with NoSuchPartException from input: ";
    public static final String SSH_EXCEPTION_ERROR = "Connection established but Failed to SCP/SFTP to server with SCP/SFTPException. SCP/SFTP Client issue: ";
    public static final String SSH_DIR_DOESNT_EXIST_ERROR = "Connection established but Failed to SCP/SFTP to server with SCP/SFTPException. Ensure Directory exists and user has correct permissions: ";
    public static final String SSH_IO_EXCEPTION = "Connection established but Failed to SCP/SFTP to server with IOException: ";
