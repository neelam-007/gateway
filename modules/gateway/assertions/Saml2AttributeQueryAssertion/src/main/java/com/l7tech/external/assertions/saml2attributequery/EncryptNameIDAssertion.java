 ...
 */
public class EncryptNameIDAssertion extends Assertion implements UsesVariables {
    ...
    public AssertionMetadata meta() {
        ...
        meta.put(AssertionMetadata.SHORT_NAME, "Encrypt NameID");
        meta.put(AssertionMetadata.LONG_NAME, "Encrypt NameID");
    ...
    private static final String META_INITIALIZED = EncryptNameIDAssertion.class.getName() + ".metadataInitialized";
}