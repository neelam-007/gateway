...
import com.l7tech.external.assertions.portalupgrade.PortalUpgradeAssertion;
...
/**
 * Server side implementation of the PortalUpgradeAssertion.
 *
 * @see com.l7tech.external.assertions.portalupgrade.PortalUpgradeAssertion
 */
public class ServerPortalUpgradeAssertion extends AbstractServerAssertion<PortalUpgradeAssertion> {

    @Inject
    private RbacServices rbacServices;

    public ServerPortalUpgradeAssertion(final PortalUpgradeAssertion assertion) throws PolicyAssertionException {
        super(assertion);
    }
    ...
    public AssertionStatus checkRequest(final PolicyEnforcementContext context) throws IOException, PolicyAssertionException {
      ...
      final User user = context.getDefaultAuthenticationContext().getLastAuthenticatedUser();
        ...
        try {
            ...
            context.setVariable("portal.update.error",ExceptionUtils.getMessage(e.getException()));
            return AssertionStatus.FAILED;
        }
