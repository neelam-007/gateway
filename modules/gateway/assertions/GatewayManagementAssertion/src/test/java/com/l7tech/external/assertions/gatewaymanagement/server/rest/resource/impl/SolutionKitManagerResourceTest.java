...
//
//        when(solutionKitManager.findBySolutionKitGuidAndIM(parentSolutionKit.getSolutionKitGuid(),"")).thenReturn(parentSolutionKit);
//        when(solutionKitManager.findAllChildrenByParentGoid(parentSolutionKit.getGoid())).thenReturn(childKits);
//
...
//
//        parentSolutionKit = new SolutionKitBuilder()
//                .goid(parentGoidSame)
//                .name("parent")
