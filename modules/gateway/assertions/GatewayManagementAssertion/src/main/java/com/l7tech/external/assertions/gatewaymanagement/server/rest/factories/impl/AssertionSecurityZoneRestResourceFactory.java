 ...
 */
@Component
public class AssertionSecurityZoneRestResourceFactory extends WsmanBaseResourceFactory<AssertionSecurityZoneMO, AssertionSecurityZoneResourceFactory> {

    @Inject
    private AssertionAccessManager assertionAccessManager;

    public AssertionSecurityZoneRestResourceFactory() {
        super(
