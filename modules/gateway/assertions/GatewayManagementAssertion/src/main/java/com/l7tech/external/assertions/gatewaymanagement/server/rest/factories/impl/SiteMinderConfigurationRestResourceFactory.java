 ...
 */
@Component
public class SiteMinderConfigurationRestResourceFactory extends WsmanBaseResourceFactory<SiteMinderConfigurationMO, SiteMinderConfigurationResourceFactory> {

    public SiteMinderConfigurationRestResourceFactory() {
        super(
