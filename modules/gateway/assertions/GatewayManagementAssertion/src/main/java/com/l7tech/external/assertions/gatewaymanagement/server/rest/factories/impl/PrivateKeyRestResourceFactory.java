 ...
 */
@Component
public class PrivateKeyRestResourceFactory extends WsmanBaseResourceFactory<PrivateKeyMO, PrivateKeyResourceFactory> {

    public PrivateKeyRestResourceFactory() {
        super(
