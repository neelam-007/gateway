 ...
 */
@Component
public class PolicyAliasRestResourceFactory extends WsmanBaseResourceFactory<PolicyAliasMO, PolicyAliasResourceFactory> {

    public PolicyAliasRestResourceFactory() {
        super(
