...
public class PublishedServiceTransformer extends APIResourceWsmanBaseTransformer<ServiceMO, PublishedService,ServiceHeader, ServiceResourceFactory> {
    ...
    public Pair<PublishedService,Collection<ServiceDocument>> convertToEntity(ServiceMO m) throws ResourceFactory.InvalidResourceException {
        return factory.fromResource(m);
    }
}
