 ...
 */
@Component
public class ListenPortRestResourceFactory extends WsmanBaseResourceFactory<ListenPortMO, ListenPortResourceFactory> {

    public ListenPortRestResourceFactory() {
        super(
