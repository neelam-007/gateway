 ...
 */
@Component
public class CustomKeyValueStoreRestResourceFactory extends WsmanBaseResourceFactory<CustomKeyValueStoreMO, CustomKeyValueStoreResourceFactory> {

    public CustomKeyValueStoreRestResourceFactory() {
        super(
