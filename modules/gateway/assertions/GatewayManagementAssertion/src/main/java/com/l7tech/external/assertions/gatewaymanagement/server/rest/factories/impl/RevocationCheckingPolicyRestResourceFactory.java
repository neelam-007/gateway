 ...
 */
@Component
public class RevocationCheckingPolicyRestResourceFactory extends WsmanBaseResourceFactory<RevocationCheckingPolicyMO, RevocationCheckingPolicyResourceFactory> {

    public RevocationCheckingPolicyRestResourceFactory() {
        super(
