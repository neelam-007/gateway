...
public class JMSDestinationResource extends RestEntityResource<JMSDestinationMO, JMSDestinationAPIResourceFactory, JMSDestinationTransformer> {
    ...
    public ItemsList<JMSDestinationMO> listResources(
        ...
        ParameterValidationUtils.validateNoOtherQueryParams(uriInfo.getQueryParameters(), Arrays.asList("name", "enabled", "inbound", "template", "destination", "securityZone.id"));
