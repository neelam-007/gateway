 ...
 */
@Component
public class ActiveConnectorRestResourceFactory extends WsmanBaseResourceFactory<ActiveConnectorMO, ActiveConnectorResourceFactory> {

    public ActiveConnectorRestResourceFactory() {
        super(
