 ...
 */
@Component
public class EmailListenerRestResourceFactory extends WsmanBaseResourceFactory<EmailListenerMO, EmailListenerResourceFactory> {

    public EmailListenerRestResourceFactory() {
        super(
