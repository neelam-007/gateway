 ...
 */
@Component
public class IdentityProviderRestResourceFactory extends WsmanBaseResourceFactory<IdentityProviderMO, IdentityProviderResourceFactory> {

    public IdentityProviderRestResourceFactory() {
        super(
