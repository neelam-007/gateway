...
public class ServerEvaluateJsonPathExpressionAssertionTest {
    ...
    public void setUp() {
        try {
            serverConfig.putProperty(EvaluateJsonPathExpressionV2Assertion.PARAM_JSON_SYSTEM_DEFAULT_EVALUATOR, "JsonPath");
            ...
            serverAssertion = new ServerEvaluateJsonPathExpressionV2Assertion(assertion, applicationContext);
        } catch (Exception e) {
    ...
    public void testJsonPathSingleStringResult() {
        testJsonPathSingleStringResult("JsonPath","Evelyn Waugh");
    }
    ...
    public void testJsonPathSingleStringResultWithoutCompression() throws IOException {
        ...
        testJsonPathSingleStringResult("JsonPath","Evelyn /test/ Waugh");
    }

    @Test
    public void testJsonPathSingleStringResultWithCompression() throws IOException {
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathSingleStringResult("JsonPathWithCompression","Evelyn /test/ Waugh");
    }
    ...
    public void testJsonPathSingleObjectResult() {
        ...
        testJsonPathSingleObjectResult("JsonPath", expected, "Evelyn Waugh");
    }
    ...
    public void testJsonPathSingleObjectResultWithoutCompression() throws IOException {
        ...
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathSingleObjectResult("JsonPath", expected, "Evelyn \\/test\\/ Waugh");
    }
    ...
    public void testJsonPathSingleObjectResultWithCompression() throws IOException {
        ...
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathSingleObjectResult("JsonPathWithCompression", expected, "Evelyn /test/ Waugh");
    }
    ...
    public void testJsonPathSingleObjectResultWithCompressionUsingCWP() throws IOException {
        ...
        serverConfig.putProperty(EvaluateJsonPathExpressionV2Assertion.PARAM_JSON_SYSTEM_DEFAULT_EVALUATOR, "JsonPathWithCompression");
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathSingleObjectResult("SystemDefault", expected, "Evelyn /test/ Waugh");
    }

    public void testJsonPathSingleObjectResult(String evaluator, String expectedJsonString, String propertyValue) {
        try {
            assertion.setEvaluator(evaluator);
    ...
    public void testJsonPathMultipleResultsObject() {
        ...
        testJsonPathMultipleResultsObject("JsonPath", expected, new String[] { "Nigel Rees", "Evelyn Waugh"});
    }
    ...
    public void testJsonPathMultipleResultsObjectWithoutCompression() throws IOException {
        ...
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathMultipleResultsObject("JsonPath", expected, new String[] { "Nigel \\/test\\/ Rees", "Evelyn \\/test\\/ Waugh"});
    }
    ...
    public void testJsonPathMultipleResultsObjectWithCompression() throws IOException {
        ...
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathMultipleResultsObject("JsonPathWithCompression", expected, new String[] { "Nigel /test/ Rees", "Evelyn /test/ Waugh"});
    }
    ...
    public void testJsonPathMultipleResultsObjectWithCompressionUsingCWP() throws IOException {
        ...
        serverConfig.putProperty(EvaluateJsonPathExpressionV2Assertion.PARAM_JSON_SYSTEM_DEFAULT_EVALUATOR, "JsonPathWithCompression");
        request.initialize(new ByteArrayStashManager(), ContentTypeHeader.APPLICATION_JSON, new ByteArrayInputStream(TEST_JSON_FOR_ESCAPED_SLASHES.getBytes()));
        testJsonPathMultipleResultsObject("SystemDefault", expected, new String[] { "Nigel /test/ Rees", "Evelyn /test/ Waugh"});
    }
    ...
    public void testInvalidJson(){
        try {
            ...
            ServerEvaluateJsonPathExpressionV2Assertion serverAssertion = new ServerEvaluateJsonPathExpressionV2Assertion(assertion,
                    applicationContext);
