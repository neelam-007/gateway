 ...
 *
 */
public class SiteMinderEnableUserAssertion extends MessageTargetableAssertion implements UsesEntities, SiteMinderAgentReference {
    //
    // Metadata
    //
    private static final String META_INITIALIZED = SiteMinderEnableUserAssertion.class.getName() + ".metadataInitialized";
    private static final String BASE_NAME = "Enable CA Single Sign-On User";
    ...
    public SiteMinderEnableUserAssertion() {
        super();
    }
    ...
    public VariablesUsed doGetVariablesUsed() {
        return super.doGetVariablesUsed().withExpressions(domOid, username);
    }
    ...
    public AssertionMetadata meta() {
        ...
        meta.put(AssertionMetadata.PROPERTIES_EDITOR_CLASSNAME, "com.l7tech.external.assertions.siteminder.console.SiteMinderEnableUserPropertiesDialog");
    ...
    static final AssertionNodeNameFactory policyNameFactory = new AssertionNodeNameFactory<SiteMinderEnableUserAssertion>(){
        @Override
        public String getAssertionName( final SiteMinderEnableUserAssertion assertion, final boolean decorate) {
