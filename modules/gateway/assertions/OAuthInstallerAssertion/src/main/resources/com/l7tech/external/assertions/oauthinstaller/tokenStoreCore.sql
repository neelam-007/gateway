...
-- 19/10/2012 (DD/MM/YYYY)
--
-- This script is used to create tables on a mysql server using the oauth installation tool.
--
...
CREATE TABLE oauth_client_key (
  ...
  client_name varchar(128) not null COMMENT 'The name of the client that owns this key. This makes it a non normalized table but what counts is performance, performance, performance ...',
...
--
-- Lets insert values for the oauth 1.0 test client
--
