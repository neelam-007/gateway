 ...
 */
public class XMPPGetSessionAttributeAssertion extends Assertion implements UsesVariables, SetsVariables {
    protected static final Logger logger = Logger.getLogger(XMPPGetSessionAttributeAssertion.class.getName());
    ...
    public String[] getVariablesUsed() {
        ...
        String[] retVal = new String[sessionIdVars.length + attributeNameVars.length];
    ...
    public AssertionMetadata meta() {
        ...
        meta.put(AssertionMetadata.SHORT_NAME, "XMPP Get Session Attribute");
        meta.put(AssertionMetadata.LONG_NAME, "XMPP Get Session Attribute Assertion");
        ...
        meta.put(AssertionMetadata.PROPERTIES_EDITOR_CLASSNAME, "com.l7tech.external.assertions.xmppassertion.console.XMPPGetSessionAttributeAssertionPropertiesDialog");
