 ...
 */
public class ServerXMPPGetSessionAttributeAssertion extends AbstractServerAssertion<XMPPGetSessionAttributeAssertion> {
    private static final Logger logger = Logger.getLogger(ServerXMPPSendToRemoteHostAssertion.class.getName());

    private final XMPPGetSessionAttributeAssertion assertion;
    private final String[] variablesUsed;

    public ServerXMPPGetSessionAttributeAssertion(XMPPGetSessionAttributeAssertion assertion, ApplicationContext context) throws PolicyAssertionException {
        super(assertion);
    ...
    public AssertionStatus checkRequest(final PolicyEnforcementContext context) throws IOException, PolicyAssertionException
    {
        try {
            ...
            String attributeValue = XMPPConnectionManager.getInstance().getSessionAttribute(sessionIdLong, assertion.isInbound(), key);
            context.setVariable(assertion.getVariableName(), attributeValue);
