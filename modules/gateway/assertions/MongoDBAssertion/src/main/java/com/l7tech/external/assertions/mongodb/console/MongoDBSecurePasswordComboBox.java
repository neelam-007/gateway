 ...
 */
public class MongoDBSecurePasswordComboBox extends SecurePasswordComboBox {

    private static Logger logger = Logger.getLogger(MongoDBSecurePasswordComboBox.class.getName());
