...
public class MigrateToRestoreConvertorTest {
    ...
    public void testStandardConvert() throws Exception {
        ...
        Assert.assertEquals("-db should be at this index", "-db", converted[20]);
        Assert.assertEquals("dbname should be at this index", "dbname", converted[21]);
        
        Assert.assertEquals("Too many args converted", 22, converted.length);
    ...
    /**
     * Test that the -os component is listed when -os is specified
     * @throws Exception
     */
    @Test
    public void testOSConvert() throws Exception {
        ...
        Assert.assertEquals("-os should be at this index", "-os", converted[20]);
    ...
    public void testNewDbConvert() throws Exception {
        ...
        Assert.assertEquals("-newdb should be at this index", "-newdb", converted[20]);
        Assert.assertEquals("newdb name should be at this index", "newdbname", converted[21]);
