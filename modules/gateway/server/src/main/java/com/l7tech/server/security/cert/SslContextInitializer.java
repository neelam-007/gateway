...
public class SslContextInitializer {
    ...
    private static class SsgKeyStoreKeyManager extends X509ExtendedKeyManager {
        ...
        public X509Certificate[] getCertificateChain( final String alias ) {
            ...
            try {
                return ssgKeyStoreManager.lookupKeyByKeyAlias( alias, PersistentEntity.DEFAULT_GOID).getCertificateChain();
            } catch ( ObjectNotFoundException e ) {
        ...
        public PrivateKey getPrivateKey( final String alias ) {
            ...
            try {
                return ssgKeyStoreManager.lookupKeyByKeyAlias( alias, PersistentEntity.DEFAULT_GOID ).getPrivateKey();
            } catch ( ObjectNotFoundException e ) {
