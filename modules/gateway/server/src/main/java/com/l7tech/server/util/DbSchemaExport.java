...
public class DbSchemaExport {
    ...
    public static final String PROP_SCRIPT = "com.l7tech.server.outputDbScript";

    /**
     *
     */
    public DbSchemaExport( final Configuration configuration,
                           final File file ) {
    ...
    private static final Logger logger = Logger.getLogger( DbSchemaExport.class.getName() );
