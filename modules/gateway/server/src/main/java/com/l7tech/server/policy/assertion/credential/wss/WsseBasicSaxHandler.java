...
public class WsseBasicSaxHandler implements ContentHandler {
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        else if (localName.equals( SoapConstants.SECURITY_EL_NAME) && insideSecurity) insideSecurity = false;
        else if (localName.equals( SoapConstants.HEADER_EL_NAME) && insideHeader) {
            insideHeader = false;
            // passed that, we are not going to find what we are seeking
            throw new SAXParsingCompleteException();
        }
        else if (localName.equals( SoapConstants.ENVELOPE_EL_NAME) && insideEnvelope) insideEnvelope = false;
    }

    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        if (localName.equals( SoapConstants.ENVELOPE_EL_NAME) && !insideEnvelope) insideEnvelope = true;
        else if (localName.equals( SoapConstants.HEADER_EL_NAME) && insideEnvelope) insideHeader = true;
        else if (localName.equals( SoapConstants.SECURITY_EL_NAME) && insideEnvelope && insideHeader) insideSecurity = true;
