...
public class ResourceProperty {
    public static final ResourceProperty RESOURCE_ID                  = new ResourceProperty("ResourceId", true);
    public static final ResourceProperty CURRENT_TIME                 = new ResourceProperty("CurrentTime", false);
    public static final ResourceProperty OPERATIONAL_STATUS           = new ResourceProperty("OperationalStatus", true);
    public static final ResourceProperty NUMBER_OF_REQUESTS           = new ResourceProperty("NumberOfRequests", true);
    public static final ResourceProperty NUMBER_OF_FAILEDREQUESTS     = new ResourceProperty("NumberOfFailedRequests", true);
    public static final ResourceProperty NUMBER_OF_SUCCESSFULREQUESTS = new ResourceProperty("NumberOfSuccessfulRequests", true);
    public static final ResourceProperty SERVICE_TIME                 = new ResourceProperty("ServiceTime", true);
    public static final ResourceProperty MAX_RESPONSETIME             = new ResourceProperty("MaxResponseTime", true);
    public static final ResourceProperty LAST_RESPONSETIME            = new ResourceProperty("LastResponseTime", true);
    public static final ResourceProperty THROUGHPUT                   = new ResourceProperty("Throughput", true);
    public static final ResourceProperty FAULTRATE                    = new ResourceProperty("FaultRate", true);
    public static final ResourceProperty AVG_RESPONSETIME             = new ResourceProperty("AvgResponseTime", true);
    public static final ResourceProperty MANAGEABILITY_CAPABILITY     = new ResourceProperty("ManageabilityCapability", false);
    public static final ResourceProperty TOPIC                        = new ResourceProperty("Topic", false);
