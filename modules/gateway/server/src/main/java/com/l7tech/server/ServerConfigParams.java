...
public interface ServerConfigParams {
    ...
    String PARAM_IO_MQ_INCLUDE_REPLY_QUEUE_MANAGER_NAME = "ioMqIncludeReplyToQueueManagerName";
    String PARAM_IO_MQ_FORCE_RETURN_PROPS_IN_MQRFH2_HEADER = "ioMqForceReturnPropertiesInMQRFH2Header";
    String PARAM_IO_MQ_CONVERT_MESSAGE_APPLICATION_DATA_FORMAT = "ioMqConvertMessageApplicationDataFormat";
    String PARAM_IO_MQ_CONVERSION_CCSID = "ioMqConversionCCSID";
