...
public class MessageSelector implements ExpandVariables.Selector<Message> {
    ...
    private static final List<Class<? extends HasHeaders>> httpHeaderHaverKnobClasses =
            Arrays.<Class<? extends HasHeaders>>asList(HttpRequestKnob.class, HeadersKnob.class, HttpOutboundRequestKnob.class, HttpResponseKnob.class, HttpInboundResponseKnob.class);
