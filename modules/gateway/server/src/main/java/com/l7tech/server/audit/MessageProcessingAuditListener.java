...
public class MessageProcessingAuditListener implements ApplicationListener {
    ...
    public MessageProcessingAuditListener(MessageSummaryAuditFactory msaf, EventChannel messageProcessingEventChannel) {
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        ...
        if (event instanceof AuditDetailEvent) {
            ...
            if (detail!=null) AuditContextFactory.getCurrent().addDetail(detail, source);
        }
    }
}
