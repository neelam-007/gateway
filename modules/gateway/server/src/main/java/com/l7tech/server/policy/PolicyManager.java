 ...
 * @author alex
 */
public interface PolicyManager extends FolderedEntityManager<Policy, PolicyHeader>, GuidBasedEntityManager<Policy>, SearchableEntityManager<Policy, PolicyHeader>, RoleAwareEntityManager<Policy> {
