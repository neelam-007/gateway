...
public class CassandraConnectionManagerImpl implements CassandraConnectionManager {
    ...
    public CassandraConnectionHolder getConnection(String name) {
        ...
        try {
            ...
            if(connectionHolder != null) {
                connectionHolder.getLastAccessTime().set(System.currentTimeMillis());//update last accessed time
            }
    ...
    private void addSSLOptions(Cluster.Builder clusterBuilder,
        ...
        if (cassandraConnectionEntity.isSsl()) {
            ...
            if ( !( cipherSuiteList == null || cipherSuiteList.equals("") ) ) {
                sslOptions = JdkSSLOptions.builder().withSSLContext(sslContext).withCipherSuites(
                        SslSocketUtil.filterUnsupportedCiphers(
    ...
    protected boolean closeConnection(CassandraConnectionHolder connection) {
        if(connection != null) {
