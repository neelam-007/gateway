...
public interface DependencyAnalyzer {
     ...
     * </table></pre>
     */
    public static final Map<String, String> DefaultSearchOptions = CollectionUtils.MapBuilder.<String, String>builder().put(SearchDepthOptionKey, "-1").unmodifiableMap();

    /**
     * Returns the set of dependencies for the given entity. This is the same as calling getDependencies(entity,
