...
public interface SsgKeyMetadataManager extends GoidEntityManager<SsgKeyMetadata, EntityHeader> {
     ...
     */
    @Nullable
    SsgKeyMetadata findMetadata(Goid keystoreGoid, @NotNull String alias) throws FindException;
     ...
     * @return the GOID assigned to the new or updated metadata instance, or -1 if newMeta was null and there was no existing metadata.
     ...
     */
    Goid updateMetadataForKey(Goid keystoreGoid, @NotNull String alias, @Nullable SsgKeyMetadata newMeta) throws FindException, SaveException, UpdateException;
     ...
     *
     * @param keystoreGoid the goid of the keystore. Required.
     ...
     */
    void deleteMetadataForKey(Goid keystoreGoid, @NotNull String alias) throws DeleteException;
}
