...
public class GatewaySanityChecker extends ApplicationObjectSupport implements InitializingBean {
    ...
    private static final Map<Class<? extends SystemEvent>, Set<String>> whitelist = CollectionUtils.<Class<? extends SystemEvent>, Set<String>>mapBuilder()
            .put(null, set(
                    ...
                    "com.l7tech.server.upgrade.Upgrade71to80UpdateGatewayManagementWsdl",
                    "com.l7tech.server.upgrade.Upgrade8102to8200UpdateGatewayManagementWsdl") )
            ...
            .put(Started.class, set(
                    ...
                    "com.l7tech.server.upgrade.Upgrade8102To8200UpdateRoles",
                    "com.l7tech.server.upgrade.Upgrade9200To9300SolutionKits") )
        .unmodifiableMap();
