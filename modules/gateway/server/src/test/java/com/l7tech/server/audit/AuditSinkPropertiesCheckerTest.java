...
public class AuditSinkPropertiesCheckerTest {
    ...
    public void testEvaluateAuditSinkPropertiesStatus() {
        ...
        serverConfig.putProperty( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, null);
        assertFalse("Audit Sink Policy is disabled", propChecker.isAuditSinkPolicyEnabled());

        serverConfig.putProperty( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, "true");
        assertTrue(" Internal Audit System is enabled", propChecker.isInternalAuditSystemEnabled(true));

        serverConfig.putProperty( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, "false");
        assertTrue(" Internal Audit System is enabled", propChecker.isInternalAuditSystemEnabled(true));

        serverConfig.putProperty( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, null);
        assertTrue(" Internal Audit System is enabled", propChecker.isInternalAuditSystemEnabled(true));

        // Case 2:  Internal Audit System: disabled--- Audit Sink Policy: enabled
        serverConfig.putProperty( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, TEST_POLICY_GUID);
    ...
    public void testAuditStatusOfInternalAuditSystem() {
        ...
        propStatusMap.clear();
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, false); // The Previous Status of "Internal Audit System" Cluster Property
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, true);      // The Current Status of "Audit Sink Policy" Cluster Property
        ClusterProperty prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, "true");
        ...
        propStatusMap.clear();
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, false); // The Previous Status of "Internal Audit System" Cluster Property
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, true);       // The Previous Status of "Audit Sink Policy" Cluster Property
        prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, null);
        ...
        propStatusMap.clear();
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, true); // The Previous Status of "Internal Audit System" Cluster Property
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, true);     // The Current Status of "Audit Sink Policy" Cluster Property
        prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, "false");
    ...
    public void testAuditStatusOfAuditSinkPolicy() {
        ...
        propStatusMap.clear();
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_ALWAYS_FALLBACK, true); // The Current Status of "Internal Audit System" Property
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, false);    // The Previous Status of "Audit Sink Policy" Cluster Property
        ClusterProperty prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_POLICY_GUID, TEST_POLICY_GUID);
    ...
    public void testFallbackToInternal() {
        ...
        propStatusMap.clear();
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, false); // The Previous Status of "Fall back to Internal" Property
        ClusterProperty prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, "true");
        ...
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, false); // The Previous Status of "Fall back to Internal" Property
        prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, null);
        ...
        propStatusMap.put( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, true); // The Previous Status of "Fall back to Internal" Property
        prop = new ClusterProperty( ServerConfigParams.PARAM_AUDIT_SINK_FALLBACK_ON_FAIL, "false");
