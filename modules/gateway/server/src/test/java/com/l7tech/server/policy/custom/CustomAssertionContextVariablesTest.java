...
@Ignore("CustomAssertionContextVariablesTest is disabled and commented-out temporary.")
...
//
//    @Test
//    public void testServiceRequest_expandVariableDefaultVariableMap() throws Exception {
//
...
//                ServiceRequest serviceRequest = (ServiceRequest) invocation.getArguments()[0];
//
//                // Not a context variable.
//                //
//                String actual = serviceRequest.expandVariable("test");
//                assertEquals("test", actual);
//
//                // Not defined context variable.
//                //
//                actual = serviceRequest.expandVariable("${test}");
//                assertEquals("", actual);
//
//                // Single-value context variable.
//                //
//                actual = serviceRequest.expandVariable("${var1}");
//                assertEquals("value_variable1", actual);
//
//                // Multi-value context variable.
//                //
//                actual = serviceRequest.expandVariable("${var2}");
//                assertEquals("value_variable2_1, value_variable2_2, value_variable2_3", actual);
//
//                actual = serviceRequest.expandVariable("${var2[0]}");
//                assertEquals("value_variable2_1", actual);
//
//                actual = serviceRequest.expandVariable("${var2[1]}");
//                assertEquals("value_variable2_2", actual);
//
//                actual = serviceRequest.expandVariable("${var2[2]}");
//                assertEquals("value_variable2_3", actual);
//
//                actual = serviceRequest.expandVariable("${var2[3]}"); // index out of range
//                assertEquals("", actual);
//
...
//
//    @Test
//    public void testServiceRequest_expandVariableUserVariableMap() throws Exception {
//
//        doAnswer(new Answer<CustomAssertionStatus>() {
//            @Override
//            public CustomAssertionStatus answer(final InvocationOnMock invocation) throws Throwable {
//                ServiceRequest serviceRequest = (ServiceRequest) invocation.getArguments()[0];
//
//                Map<String, Object> vars = serviceRequest.getVariableMap(new String[]{"var1", "var2"});
//
//                // Not a context variable.
//                //
//                String actual = serviceRequest.expandVariable("test", vars);
//                assertEquals("test", actual);
//
//                // Not defined context variable.
//                //
//                actual = serviceRequest.expandVariable("${test}", vars);
//                assertEquals("", actual);
//
//                // Single-value context variable.
//                //
//                actual = serviceRequest.expandVariable("${var1}", vars);
//                assertEquals("value_variable1", actual);
//
//                // Multi-value context variable.
//                //
//                actual = serviceRequest.expandVariable("${var2}", vars);
//                assertEquals("value_variable2_1, value_variable2_2, value_variable2_3", actual);
//
//                actual = serviceRequest.expandVariable("${var2[0]}", vars);
//                assertEquals("value_variable2_1", actual);
//
//                actual = serviceRequest.expandVariable("${var2[1]}", vars);
//                assertEquals("value_variable2_2", actual);
//
//                actual = serviceRequest.expandVariable("${var2[2]}", vars);
//                assertEquals("value_variable2_3", actual);
//
//                actual = serviceRequest.expandVariable("${var2[3]}", vars); // index out of range
//                assertEquals("", actual);
//
//                // Multi-value context variable with user specified delimiter
//                //
...
//
//    @Test
//    public void testServiceResponse_expandVariableDefaultVariableMap() throws Exception {
//
//        doAnswer(new Answer<CustomAssertionStatus>() {
//            @Override
//            public CustomAssertionStatus answer(final InvocationOnMock invocation) throws Throwable {
//                ServiceResponse serviceResponse = (ServiceResponse) invocation.getArguments()[1];
//
//                // Not a context variable.
//                //
//                String actual = serviceResponse.expandVariable("test");
//                assertEquals("test", actual);
//
//                // Not defined context variable.
//                //
//                actual = serviceResponse.expandVariable("${test}");
//                assertEquals("", actual);
//
//                // Single-value context variable.
//                //
//                actual = serviceResponse.expandVariable("${var1}");
//                assertEquals("value_variable1", actual);
//
//                // Multi-value context variable.
//                //
//                actual = serviceResponse.expandVariable("${var2}");
//                assertEquals("value_variable2_1, value_variable2_2, value_variable2_3", actual);
//
//                actual = serviceResponse.expandVariable("${var2[0]}");
//                assertEquals("value_variable2_1", actual);
//
//                actual = serviceResponse.expandVariable("${var2[1]}");
//                assertEquals("value_variable2_2", actual);
//
//                actual = serviceResponse.expandVariable("${var2[2]}");
//                assertEquals("value_variable2_3", actual);
//
//                actual = serviceResponse.expandVariable("${var2[3]}"); // index out of range
//                assertEquals("", actual);
//
//                // Multi-value context variable with user specified delimiter
//                //
...
//
//    @Test
//    public void testServiceResponse_expandVariableUserVariableMap() throws Exception {
//
//        doAnswer(new Answer<CustomAssertionStatus>() {
//            @Override
//            public CustomAssertionStatus answer(final InvocationOnMock invocation) throws Throwable {
//                ServiceResponse serviceResponse = (ServiceResponse) invocation.getArguments()[1];
//
//                Map<String, Object> vars = serviceResponse.getVariableMap(new String[]{"var1", "var2"});
//
//                // Not a context variable.
//                //
//                String actual = serviceResponse.expandVariable("test", vars);
//                assertEquals("test", actual);
//
//                // Not defined context variable.
//                //
//                actual = serviceResponse.expandVariable("${test}", vars);
//                assertEquals("", actual);
//
//                // Single-value context variable.
//                //
//                actual = serviceResponse.expandVariable("${var1}", vars);
//                assertEquals("value_variable1", actual);
//
//                // Multi-value context variable.
//                //
//                actual = serviceResponse.expandVariable("${var2}", vars);
//                assertEquals("value_variable2_1, value_variable2_2, value_variable2_3", actual);
//
//                actual = serviceResponse.expandVariable("${var2[0]}", vars);
//                assertEquals("value_variable2_1", actual);
//
//                actual = serviceResponse.expandVariable("${var2[1]}", vars);
//                assertEquals("value_variable2_2", actual);
//
//                actual = serviceResponse.expandVariable("${var2[2]}", vars);
//                assertEquals("value_variable2_3", actual);
//
//                actual = serviceResponse.expandVariable("${var2[3]}", vars); // index out of range
//                assertEquals("", actual);
//
//                // Multi-value context variable with user specified delimiter
//                //
