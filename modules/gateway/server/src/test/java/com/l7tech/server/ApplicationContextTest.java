...
public class ApplicationContextTest  {
    ...
    private static final Set<String> TRANSACTION_ROLLBACK_WHITELIST = set( "adminLogin", "clusterIDManager", "counterManager", "debugAdmin", "distributedMessageIdManager", "ftpAdmin", "kerberosAdmin", "schemaEntryManager", "trustedSignerCertsAdmin");
