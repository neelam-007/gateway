...
public class SsgConnectorTest extends DependencyTestBaseClass {
    ...
    private Dependency myDependency = new Dependency(new DependentEntity("dependentName", EntityType.ANY, new Goid(0,1).toString(), String.valueOf(idCount.getAndIncrement())));
    ...
    public void test() throws FindException {
        ...
        Assert.assertEquals(ssgConnectorOid, Long.parseLong(((DependentEntity) result.getDependent()).getId()));
