...
/**
 * The API published by a Service Node for use by the Process Controller
 * 
 * @author alex
 */
@WebService(name="Service Node API", targetNamespace = "http://ns.l7tech.com/secureSpan/5.0/component/processController/serviceNodeApi")
public interface ServiceNodeApi {
    ...
    /**
     * Asks the Service Node to release the subscriptions with the specified IDs.  Unrecognized IDs will be silently ignored.
    ...
    /**
     * Gets the value of the Service Node property with the specified ID.
     *
     * @param propertyId the ID of the property to retrieve
     * @return the value of the property with the specified ID
     * @throws UnsupportedPropertyException if the specified property ID isn't supported by the Service Node
