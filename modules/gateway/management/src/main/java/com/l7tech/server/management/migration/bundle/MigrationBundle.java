...
@XmlSeeAlso(value = {PublishedService.class, PublishedServiceAlias.class, PolicyAlias.class, ServiceDocument.class, EncapsulatedAssertionConfig.class, ExportedItem.class})
