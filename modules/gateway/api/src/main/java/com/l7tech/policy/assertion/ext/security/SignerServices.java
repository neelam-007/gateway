...
public interface SignerServices {
    ...
    /** A special key ID that always refers to the Gateway's current default CA key, if any, regardless of its alias. */
    static final String KEY_ID_CA = "XX:CA";
     ...
     *              or the special key ID {@link #KEY_ID_SSL} or {@link #KEY_ID_CA}.
     *
