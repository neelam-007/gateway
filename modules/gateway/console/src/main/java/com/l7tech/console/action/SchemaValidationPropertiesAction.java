...
public class SchemaValidationPropertiesAction extends SecureAction {
    ...
    protected void performAction() {
        SchemaValidation me = node.asAssertion();
        ...
        final SchemaValidationPropertiesDialog dlg = new SchemaValidationPropertiesDialog(TopComponents.getInstance().getTopParent(), node, service, inferredTarget);
        dlg.pack();
