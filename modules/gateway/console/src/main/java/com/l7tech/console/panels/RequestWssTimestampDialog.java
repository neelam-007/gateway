 ...
 * @author alex
 */
public class RequestWssTimestampDialog extends AssertionOkCancelDialog<RequestWssTimestamp> {
    ...
    public RequestWssTimestampDialog(Frame owner, RequestWssTimestamp assertion) {
        super(owner, resources.getString("dialog.title"), new RequestWssTimestampPanel(assertion), assertion);
    }
}
