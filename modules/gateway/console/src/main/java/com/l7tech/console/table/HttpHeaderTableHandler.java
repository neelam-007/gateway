...
public class HttpHeaderTableHandler {
    ...
    public HttpHeaderTableHandler(final JTable table,
        ...
        List<HttpHeader> headers = httpConfiguration.getHeaders();
        this.table = table;
    ...
    private Object[][] dataToRows(java.util.List headers) {
        if (headers == null || headers.size() < 1) {
            ...
            while (iterator.hasNext()){
                ...
                output[counter][1] = header.getValue();
                counter++;
            }
            return output;
        }
    ...
    public List<HttpHeader> getData() {
