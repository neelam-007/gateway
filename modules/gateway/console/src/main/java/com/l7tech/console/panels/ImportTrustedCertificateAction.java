 ...
 * @author Steve Jones
 */
public class ImportTrustedCertificateAction extends SecureAction {
     ...
     */
    public ImportTrustedCertificateAction(CertListener listener, String name) {
    ...
    protected void performAction(final ActionEvent actionEvent) {
        ...
        final CertificateImportDialog dialog = new CertificateImportDialog( parent,listener );
