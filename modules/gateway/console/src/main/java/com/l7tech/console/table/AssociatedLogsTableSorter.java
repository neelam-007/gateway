            ...
            switch (column) {
                case ASSOCIATED_LOG_TIMESTAMP_COLUMN_INDEX:
                    ...
                    if (elementA instanceof Long && elementB instanceof Long &&
                        ((Long) elementA).longValue() == ((Long) elementB).longValue()) {
                        // use ordinals to resolve timestamps
                        elementA = new Long(((AssociatedLog) a).getOrdinal());
                        elementB = new Long(((AssociatedLog) b).getOrdinal());
                    }
                    break;
