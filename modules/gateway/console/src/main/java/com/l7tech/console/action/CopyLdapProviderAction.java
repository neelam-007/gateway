...
/**
 * The <code>CopyLdapProviderAction</code> action copies a LDAP provider
 */
public class CopyLdapProviderAction extends NewProviderAction {
    static final Logger log = Logger.getLogger(CopyLdapProviderAction.class.getName());
    ...
    protected void performAction() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                LdapIdentityProviderConfig newLdap = new LdapIdentityProviderConfig(getIdentityProviderConfig((EntityHeaderNode) node));
