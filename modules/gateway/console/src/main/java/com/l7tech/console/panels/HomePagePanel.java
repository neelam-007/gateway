...
public class HomePagePanel extends JPanel {
    ...
    public HomePagePanel() {
        ...
        ImageIcon logoSmall = new ImageIcon(cl.getResource(MainWindow.RESOURCE_PATH + "/CA_Logo_Black_2014_72x57.png"));
    ...
    private List<HomePageToolbarAction> createActionList() {
        ...
        add("services32.png", new PublishReverseWebProxyAction());
