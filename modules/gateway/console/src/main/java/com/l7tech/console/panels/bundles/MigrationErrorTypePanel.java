...
public class MigrationErrorTypePanel {
    ...
    public void addMigrationError(final String name, final String srcId, final String extraInfo, final JButton[] selectAllButtons) { // For Policy or Service entity, extraInfo is a policy xml.
        errorTypeContainerPanel.add(
                new MigrationEntityDetailPanel(parent, errorType, targetType, name, srcId, versionModified, extraInfo, selectedMigrationResolutions, selectAllButtons).getContentPane()
        );
    }
