...
public class SignedSaml2Test extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(SignedSaml2Test.class);
        return suite;
    }
    ...
    public Document getSignedHolderOfKey(final String assertionId, boolean useThumbprintForSignature, boolean useThumbprintForSubject) throws Exception {
        ...
        SamlAssertionGenerator.signAssertion(options, assertionDoc, caPrivateKey, caCertChain, useThumbprintForSignature);
        return assertionDoc;
    }
