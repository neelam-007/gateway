...
//        sba.setMethod(GenericHttpClient.METHOD_GET);
        ...
        ApplicationContext spring = ApplicationContexts.getTestApplicationContext();
        ...
        pec.setCredentials(LoginCredentials.makePasswordCredentials("testuser", "passw0rd".toCharArray(), HttpBasic.class));
