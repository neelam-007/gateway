...
public class GetKnobTest {
    public static void main(String[] args) throws Exception {
        ...
        BenchmarkRunner test = new BenchmarkRunner(new Runnable() {
            public void run() {
                try {
                    final InputStream reqStream = TestDocuments.getTestDocumentURL(TestDocuments.PLACEORDER_CLEARTEXT).openStream();
                    final InputStream respStream = TestDocuments.getTestDocumentURL(TestDocuments.DOTNET_SIGNED_REQUEST2).openStream();
