...
public class KeyInfoThumbprintTestMessage extends TestCase {
    ...
    public MsgInfo makeTestMessage() throws Exception {
        ...
        X509Certificate senderCert = TestDocuments.getWssInteropAliceCert();
        PrivateKey senderPrivateKey = TestDocuments.getWssInteropAliceKey();
                                   ...
                                   String thumbprint)
    {
        ...
        XmlUtil.setTextContent(refEl, thumbprint);
