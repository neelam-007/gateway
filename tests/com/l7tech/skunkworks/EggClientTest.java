...
public class EggClientTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final X509Certificate aliceCert = TestDocuments.getWssInteropAliceCert();
        ...
        if (ssg.getClientCertificate() == null || !CertUtils.certsAreEqual(ssg.getClientCertificate(), aliceCert));
            ksm.saveClientCertificate(TestDocuments.getWssInteropAliceKey(), aliceCert, "asdfasdf".toCharArray());
