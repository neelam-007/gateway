...
public class LogAdminStub implements LogAdmin {
    ...
    public String[] getSystemLog(long startMsgNumber, long endMsgNumber, int size) throws RemoteException {
        ...
        String[] logs = {
            ...
            "5|20031023 10:55:18.171|INFO|com.l7tech.common.util.UptimeMonitor|runMonitorThread|Uptime monitor thread is starting",
            "4|20031023 10:55:18.140|INFO|com.l7tech.common.util.UptimeMonitor|findUptime|Using uptime executable: c:/cygwin/bin/uptime",
