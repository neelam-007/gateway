...
- Download the J2SE v 1.4.2 Windows JRE from http://java.sun.com/j2se/1.4.2/download.html
- Install the JRE to some directory, ie C:\
- Delete from the copied JRE all files listed as Optional in the j2re1.4.2/README.txt
- Edit ClientProxy.nsi and change the J2RE to j2re1.4.2, and J2RE_PATH to that path to your local copy.
